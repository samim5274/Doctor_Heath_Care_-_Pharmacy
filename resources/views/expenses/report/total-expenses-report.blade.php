            ...
            <div class="container-fluid">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="m-0">Expenses Report</h4>
                        <h5 class="m-0 text-primary">
                            <a href="{{url('/print-total-expenses-report')}}" target="_blank"><i class="fa-solid fa-print"></i> Print </a>
                        </h5>
                    </div>
                    ...
                    <!-- Filter Form -->
                     <div class="card">
                        <div class="card-body">                            
                            <form method="GET" action="{{url('/filter-expenses-report')}}" target="_blank">
