                ...
                <div class="container-fluid">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="fw-bold text-dark">Total Sale Report</h3>
                        ...
                        <!-- Filter Form -->
                        <form method="GET" action="{{url('/filter-date-wise-sale-report')}}" target="_blank" class="mb-4 p-3 rounded border bg-light">
