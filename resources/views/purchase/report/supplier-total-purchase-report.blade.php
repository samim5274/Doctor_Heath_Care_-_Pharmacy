            ...
            <div class="container-fluid">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="m-0">Supplier Purchase Report</h4>
                        <h5 class="m-0 text-primary">
                            <a href="{{url('/print/supplier/purchase/report')}}" target="_blank"><i class="fa-solid fa-print"></i> Print </a>
                        </h5>
                    </div>

                    <!-- Filter Form -->
                    <form method="GET" action="{{url('/search-supplier-purchase')}}" target="_blank">
                        <div class="card">
                            <div class="card-body">                                
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-12">
                                        <label for="cbxSupplier" class="form-label">Select Supplier</label>
                                        <select name="cbxSupplier" id="cbxCategory" class="form-select" required>
