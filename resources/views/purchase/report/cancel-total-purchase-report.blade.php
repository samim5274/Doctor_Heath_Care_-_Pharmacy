            ...
            <div class="container-fluid">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="m-0">Purchase Cancel Report</h4>
                        <h5 class="m-0 text-primary">
                            <a href="{{url('/print/purchase/order/cancel/report')}}" target="_blank"><i class="fa-solid fa-print"></i> Print </a>
                        </h5>
                    </div>

                    <!-- Filter Form -->
                    <form method="GET" action="{{url('/search-purchase-cancel-report')}}" target="_blank" class="mb-4 p-3 rounded border bg-light">
