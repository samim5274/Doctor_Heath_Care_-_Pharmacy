...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
                                    ...
                                    <div class="card h-100 shadow-sm border-0">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <span class="fw-bold text-dark" data-price="{{ $val->unit_price }}">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <div class="input-group input-group-sm" style="width: 120px;">
                                                    ...
                                                    <input type="number" class="form-control text-center qty-input" value="{{ $val->qty }}" min="1" name="txtStock" data-id="{{ $val->id }}">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="fw-semibold text-success item-subtotal">
                                                    ৳{{ number_format($val->unit_price * $val->qty, 2) }}
                                                </span>
                                            </div>
                                        </div>
                                        <div class="card-footer text-end bg-white border-0">
                                            <a href="{{ url('/remove-to-cart/'.$val->medicine_id.'/'.$val->reg) }}" class="btn btn-sm btn-outline-danger">Remove</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                        ...
                        <div class="card mt-3">
                            <div class="card-body p-3 p-md-4">
                                <form action="{{url('/confirm-order')}}" method="POST" id="myForm">
                                    ...
                                    <input type="hidden" id="cart-total-input" name="txtSubTotal" value="{{ $reg }}">
    ...
    <script src="{{ asset('assets/js/updateQty.js') }}"></script>
