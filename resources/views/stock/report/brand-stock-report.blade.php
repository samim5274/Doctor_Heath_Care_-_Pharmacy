            ...
            <div class="container-fluid">
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="m-0">Brand Stock Report</h4>
                    ...
                    <!-- Filter Form -->
                    <form method="GET" action="{{url('/search-brand-stock-report')}}" target="_blank">
                        <div class="row g-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <label for="cbxCategory" class="form-label">Select Brand</label>
                                        <select name="cbxCategory" id="cbxCategory" class="form-select" required>
